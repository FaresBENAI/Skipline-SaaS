         ...
         <div className="flex items-center justify-between">
           <div className="flex items-center">
             ...
             <div>
               ...
               <p className="text-blue-700 text-sm">
                 Présentez ce code aux entreprises pour vous inscrire rapidement
               </p>
             </div>
           </div>
           <div className="flex space-x-3">
             <button
               ...
               className="bg-white border-2 border-blue-200 text-blue-700 px-4 py-2 rounded-lg hover:bg-blue-50 flex items-center space-x-2"
             >
           ...
           <div className="text-center py-16">
             ...
             <div className="bg-blue-50 rounded-xl p-6 max-w-md mx-auto">
               ...
               <ol className="text-sm text-blue-800 space-y-2 text-left list-decimal list-inside">
                 <li>Scannez le QR code d'une entreprise</li>
                 <li>Ou présentez votre QR code à l'entreprise</li>
                 <li>Vous êtes ajouté automatiquement à leur file</li>
                 <li>Suivez votre position ici en temps réel !</li>
               </ol>
             </div>
           </div>
         ) : (
               ...
               <div>
                 ...
                 <div className="rounded-lg p-4 bg-blue-50">
                   <p className="text-sm text-blue-800">
                     ...
                     pour être ajouté rapidement à leurs files d'attente !
                   </p>
                 </div>
               </div>
             ) : (
